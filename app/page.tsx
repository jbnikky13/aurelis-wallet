...
export default function Home() {
  ...
  useEffect(() => { const a = new URLSearchParams(window.location.search).get('address') as `0x${string}` | null; if (a) setAddress(a); }, []);
